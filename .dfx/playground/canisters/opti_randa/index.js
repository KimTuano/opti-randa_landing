...
import { idlFactory } from './opti_randa.did.js';
export { idlFactory } from './opti_randa.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.OPTI_RANDA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./opti_randa.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the opti_randa canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./opti_randa.did.js")._SERVICE>}
 */
export const opti_randa = createActor(canisterId);
